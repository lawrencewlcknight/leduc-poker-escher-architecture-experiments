#!/usr/bin/env python3
"""Build Google Cloud Batch jobs for Experiment 24."""
...
MODULE = "experiments.leduc_poker.selected_ucv_36h_confirmation.run"
TASK_COUNT = 5
...
WORK_ROOT=/workspace/selected-ucv-36h
...
uv venv --python 3.9 --seed /tmp/selected-ucv-36h-venv
source /tmp/selected-ucv-36h-venv/bin/activate
...
WORK_ROOT="/workspace/exp24-controller-${{BATCH_TASK_RETRY_ATTEMPT:-0}}"
REPOSITORY="$WORK_ROOT/repository"
...
export EXP24_REMOTE_CONTROLLER=1

exec bash gcp/run_selected_ucv_36h_confirmation.sh "$CONTROLLER_ACTION"
"""
...
import sys
from experiments.leduc_poker.selected_ucv_36h_confirmation.config import PRODUCTION_SEEDS, task_schedule
...
def build_job(args) -> dict:
    ...
    return {
        ...
        "labels": {"experiment": "selected-ucv-36h", "stage": args.kind},
    }
