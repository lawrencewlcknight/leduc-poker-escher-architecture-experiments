...
def worker_dir(root, index, seed):
    return Path(root) / "workers" / f"task_{index:03d}_policy_fit_seed_{seed}"
...
def cmd_aggregate(args):
    ...
    print(json.dumps(aggregate_workers(
        ...
        output_dir=Path(args.output_root) / "analysis", smoke=args.smoke,
    ), indent=2))
...
def cmd_smoke(args):
    ...
    print(json.dumps(aggregate_workers(
        ...
        output_dir=output_root / "analysis", smoke=True,
    ), indent=2))
