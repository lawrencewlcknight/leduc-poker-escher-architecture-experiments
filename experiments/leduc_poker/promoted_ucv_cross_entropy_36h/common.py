"""Persistence helpers for Experiment 29."""
...
def augment_snapshot(
    ...
    *,
    ...
    payload.update(
        {
            "experiment_29_schema_version": 1,
...
def validate_records(
    ...
    *,
    ...
    for record, target in zip(records, schedule):
        if record["candidate_id"] != candidate_id or int(record["seed"]) != int(seed):
            raise ValueError("Snapshot candidate or seed differs from worker contract")
